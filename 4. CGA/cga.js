...
var miniMap = L.map("miniMap", {
  center: [36.174465, -86.76796],
  zoom: 11
});
L.tileLayer(
  "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoidGFsbGlhYmxlLXNvY2lldG9sb2d5IiwiYSI6ImNrcmF2ODlkcjNpY3YycnJ4OTR6eWVhNmEifQ.wIwj4TNBBVeScPzezR5I0g",
  {
    maxZoom: 18,
    tileSize: 512,
    zoomOffset: -1,
...
//MNDES
//Marker
var mndes = L.marker([36.158056, -86.770278], {
  opacity: 0.5
}).addTo(miniMap);
//Pop-up
...
//CGA
//Marker
var cga = L.marker([36.181944, -86.873333]).addTo(miniMap);
//Pop-up
